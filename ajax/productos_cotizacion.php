...
require_once ("../config/db.php");//Contiene las variables de configuracion para conectar a la base de datos
  ...
  $consulta2="SELECT precio_producto FROM productos_demo";


  $ejecutar= mysqli_query($con,$consulta2) or die (mysqli_error($con));
  ?>

<option value="">Opciones</option>
  <?php foreach ($ejecutar as $opciones): ?>

      <option value="<?php echo $opciones['precio_producto']?>"><?php echo $opciones['precio_producto']?></option>
